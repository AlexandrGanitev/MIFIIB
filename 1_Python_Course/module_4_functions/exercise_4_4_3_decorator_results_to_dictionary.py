...
print("Первый запрос функции: ", f(11)) # возвращено из wrapper-a, как cache_dict[num]
print("Второй запрос функции: ", f(22))
print("Третий запрос функции: ", f(11)) # так как 11 передавалось уже, то оно берется из кэша
